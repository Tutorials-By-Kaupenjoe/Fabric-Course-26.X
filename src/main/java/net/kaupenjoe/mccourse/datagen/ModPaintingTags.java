...
public class ModPaintingTags extends FabricTagsProvider<PaintingVariant> {
    public ModPaintingTags(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookupFuture) {
