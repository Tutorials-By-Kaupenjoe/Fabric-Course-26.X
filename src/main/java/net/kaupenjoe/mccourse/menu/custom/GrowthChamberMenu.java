...
public class GrowthChamberMenu extends AbstractContainerMenu {
    ...
    public GrowthChamberMenu(int pContainerId, Inventory inv, BlockPos pos) {
    ...
    public GrowthChamberMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.GROWTH_CHAMBER_MENU, pContainerId);

        blockEntity = ((GrowthChamberBlockEntity) entity);
        ...
        this.addSlot(new Slot(inventory, 0, 26, 11));
        this.addSlot(new Slot(inventory, 1, 26, 34));
        this.addSlot(new Slot(inventory, 2, 26, 57));
